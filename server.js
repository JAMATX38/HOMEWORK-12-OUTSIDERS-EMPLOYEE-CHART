...
function viewEmployees() {
    const queryString = `SELECT employee_table.id, employee_table.first_name, employee_table.last_name, role_table.title, department_table.dept_name AS department, role_table.salary, CONCAT(manager.first_name, ' ', manager.last_name) AS manager FROM outsiders_db.employee_table LEFT JOIN outsiders_db.role_table ON employee_table.role_id = role_table.id LEFT JOIN outsiders_db.department_table on role_table.department_id = department_table.id LEFT JOIN outsiders_db.employee_table manager ON manager.id = employee_table.manager_id ORDER BY employee_table.id;`;
...
function viewEmpByDept() {
    const queryString = `SELECT employee_table.id, employee_table.first_name, employee_table.last_name, role_table.title, department_table.dept_name AS department FROM outsiders_db.employee_table LEFT JOIN outsiders_db.role_table ON employee_table.role_id = role_table.id LEFT JOIN outsiders_db.department_table ON department_table.id = role_table.department_id ORDER BY role_table.title`;
    connectMySql.query(queryString, function(err, choice) {
        if (err) throw err;
        console.table(choice);
        start();
...
function viewEmpByMgr() {
    const queryString = `SELECT employee_table.id, employee_table.first_name, employee_table.last_name, CONCAT(manager.first_name, ' ', manager.last_name) AS manager FROM outsiders_db.employee_table LEFT JOIN outsiders_db.employee_table manager ON manager.id = employee_table.manager_id ORDER BY manager;`;
    connectMySql.query(queryString, function(err, choice) {
        if (err) throw err;
        console.table(choice);
        start();
...
function viewRoles() {
    const queryString = "SELECT * FROM outsiders_db.role_table;";
    connectMySql.query(queryString, function(err, choice) {
        if (err) throw err;
        console.table(choice);
        start();
...
function viewAllDept() {
    const queryString = "SELECT * FROM outsiders_db.department_table;";
    connectMySql.query(queryString, function(err, choice) {
        if (err) throw err;
        console.table(choice);
        start();
                    ...
                    if (
                        ...
                        inquirer
                            ...
                            .then(choice => {
                                ...
                                const queryString = `INSERT INTO outsiders_db.employee_table (first_name, last_name, role_id, manager_id) VALUES (?, ?, ?, ?);`;
                                connectMySql.query(
                                    queryString,
        ...
        .then(result => {
            inquirer
                ...
                .then(data => {
                    ...
                    const queryString =
                        "INSERT INTO outsiders_db.role_table (title, salary, department_id) values (?, ?, ?);";
                        connectMySql.query(
                        queryString,
...
function addDept() {
    inquirer
        ...
        .then(data => {
            const queryString = `INSERT INTO outsiders_db.department_table (dept_name) values (?);`;
        ...
        .then(result => {
            inquirer
                ...
                .then(data => {
                    ...
                    const queryString = `UPDATE outsiders_db.employee_table SET role_id=? WHERE first_name=?;`;
                    connectMySql.query(
                        queryString,
...
function employeeQuery() {
    return new Promise((resolve, reject) => {
        const queryString = `SELECT * FROM outsiders_db.employee_table;`;
